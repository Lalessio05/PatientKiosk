...
import com.lalessio.patientkiosk.data.local.dao.MetaDao
...
@Database(
    entities = [QuestionnaireEntity::class, QuestionEntity::class, SubscaleEntity::class, BandEntity::class, SessionEntity::class, MetaEntity::class],
    version = 1,
